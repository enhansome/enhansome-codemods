...
* [@putout/plugin-react-router](https://github.com/coderaiser/putout/tree/master/packages/plugin-react-router) ⭐ 795 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-19 - Putout plugin adds ability to migrate to latest version of react router.
...
* [@mui/codemod](https://github.com/mui/material-ui/tree/master/packages/mui-codemod) ⭐ 99,060 | 🐛 1,465 | 🌐 JavaScript | 📅 2026-09-18 - A collection of codemod scripts based for use with jscodeshift that help update MUI APIs.
...
* [awesome-jscodeshift](https://github.com/sejoker/awesome-jscodeshift) ⭐ 414 | 🐛 5 | 📅 2023-10-22
