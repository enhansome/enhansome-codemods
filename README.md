...
* [@putout/plugin-react-router](https://github.com/coderaiser/putout/tree/master/packages/plugin-react-router) ⭐ 797 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-25 - Putout plugin adds ability to migrate to latest version of react router.
...
* [@mui/codemod](https://github.com/mui/material-ui/tree/master/packages/mui-codemod) ⭐ 98,920 | 🐛 1,492 | 🌐 JavaScript | 📅 2026-08-25 - A collection of codemod scripts based for use with jscodeshift that help update MUI APIs.
