...
* [@putout/plugin-react-router](https://github.com/coderaiser/putout/tree/master/packages/plugin-react-router) ⭐ 795 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-15 - Putout plugin adds ability to migrate to latest version of react router.
...
* [django-codemod](https://github.com/browniebroke/django-codemod) ⭐ 190 | 🐛 8 | 🌐 Python | 📅 2026-09-15 - A tool to automatically fix Django deprecations.
