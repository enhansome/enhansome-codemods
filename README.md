...
* [eslint-transforms](https://github.com/eslint/eslint-transforms) ⭐ 31 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-11 - Codemods for the ESLint ecosystem.
...
* [react-codemod](https://github.com/reactjs/react-codemod) ⭐ 4,411 | 🐛 57 | 🌐 JavaScript | 📅 2026-02-22 - React codemod scripts to update React APIs.
...
* [over\_react\_codemod](https://github.com/Workiva/over_react_codemod) ⭐ 3 | 🐛 13 | 🌐 Dart | 📅 2026-08-26 - Codemods to help consumers of over\_react automate the migration of UI component code.
...
* [@putout/plugin-react-router](https://github.com/coderaiser/putout/tree/master/packages/plugin-react-router) ⭐ 796 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-27 - Putout plugin adds ability to migrate to latest version of react router.
...
* [@mui/codemod](https://github.com/mui/material-ui/tree/master/packages/mui-codemod) ⭐ 98,948 | 🐛 1,483 | 🌐 JavaScript | 📅 2026-08-27 - A collection of codemod scripts based for use with jscodeshift that help update MUI APIs.
...
* [django-codemod](https://github.com/browniebroke/django-codemod) ⭐ 190 | 🐛 11 | 🌐 Python | 📅 2026-08-27 - A tool to automatically fix Django deprecations.
