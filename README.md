...
* [@putout/plugin-react-router](https://github.com/coderaiser/putout/tree/master/packages/plugin-react-router) ⭐ 796 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-11 - Putout plugin adds ability to migrate to latest version of react router.
...
* [@mui/codemod](https://github.com/mui/material-ui/tree/master/packages/mui-codemod) ⭐ 99,026 | 🐛 1,463 | 🌐 JavaScript | 📅 2026-09-11 - A collection of codemod scripts based for use with jscodeshift that help update MUI APIs.
...
* [django-codemod](https://github.com/browniebroke/django-codemod) ⭐ 190 | 🐛 8 | 🌐 Python | 📅 2026-09-10 - A tool to automatically fix Django deprecations.
